...
/**
 * Crash Handler.
 * @author YoshiCrafter29, Ne_Eo, MAJigsaw77 and Homura Akemi (HomuHomu833) <- reference and final -> sysource_xyz
 */
class CrashHandler
{
    ...
    {
        // Salvar logs no armazenamento interno do aplicativo
        final folder:String = lime.system.System.applicationStorageDirectory + "/crash/";
        try
        {
