...
class UpdateScreen extends MusicBeatState {
    ...
    public function new(check:UpdateCheckCallback) {
        super(false);
        updater = new AsyncUpdater(["assets/updates/update-assets.zip"]); // Carregar arquivos internos
    }
    ...
    public override function update(elapsed:Float) {
        ...
        switch(prog.step) {
            ...
            case INSTALLING:
                ...
                generalProgress.text = "Installing new files... (2/2)";
        ...
        if (done = prog.done) {
            ...
            FlxG.camera.fade(0xFF000000, overSound.length / 1000, false, function() {
                // Após a atualização, voltar para o TitleState
