...
class CharacterEditor extends UIState {
    ...
    public override function create() {
        ...
        characterBG = new FunkinSprite(0, 0, Paths.image('assets/editors/character/WOAH'));
    ...
    // Salvamento no armazenamento interno
    function _file_save(_) {
        var savePath = lime.system.System.applicationStorageDirectory + "/characters/" + character.curCharacter + ".xml";
        CoolUtil.safeSaveFile(savePath, buildCharacter());
        undos.save();
        trace("Arquivo salvo em: " + savePath);
    }
