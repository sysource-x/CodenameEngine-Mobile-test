...
class PlaytestingWarningSubstate extends MusicBeatSubstate
{
    ...
    override function create() {
        ...
        // Carregar título do diretório interno
        titleAlphabet = new Alphabet(0, 140, "UNSAVED CHANGES!", true);
        titleAlphabet.frames = FlxAtlasFrames.fromSparrow("assets/images/menus/Alphabet.png", "assets/images/menus/Alphabet.xml");
        titleAlphabet.animation.addByPrefix("idle", "title_idle", 24, true);
        titleAlphabet.animation.play("idle");
        ...
        for (buttonData in buttonsData) {
            ...
            if (buttonData.color != null) textOption.color = buttonData.color;
    ...
    function changeSelection(change:Int) {
        // Carregar som de navegação do diretório interno
        CoolUtil.playMenuSFX("assets/sounds/menu/scroll.ogg", 0.7);
