...
class StoryMenuState extends MusicBeatState {
    ...
    public override function create() {
        ...
        weekTitle.setFormat("assets/fonts/vcr.ttf", 32, FlxColor.WHITE, RIGHT);
        weekTitle.alpha = 0.7;
        ...
        // DUMBASS ARROWS
        var assets = FlxAtlasFrames.fromSparrow("assets/images/menus/storymenu/assets.png", "assets/images/menus/storymenu/assets.xml");
        ...
        for(i=>week in weeks) {
            var spr:MenuItem = new MenuItem(0, (i * 120) + 480, 'assets/images/menus/storymenu/weeks/${week.sprite}.png');
            weekSprites.add(spr);
            ...
            for(e in week.difficulties) {
                ...
                if (difficultySprites[le] == null) {
                    ...
                    diffSprite.loadAnimatedGraphic("assets/images/menus/storymenu/difficulties/${le}.png");
