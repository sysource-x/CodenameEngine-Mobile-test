...
class TitleState extends MusicBeatState
{
    ...
    function startIntro()
    {
        ...
        if (titleText == null) {
            ...
            titleText.frames = FlxAtlasFrames.fromSparrow("assets/images/menus/titlescreen/titleEnter.png", "assets/images/menus/titlescreen/titleEnter.xml");
        ...
        #if !TITLESCREEN_XML
        ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadAnimatedGraphic("assets/images/menus/titlescreen/newgrounds_logo.png");
        add(ngSpr);
        ngSpr.visible = false;
    ...
    {
        var fullText:String = Assets.getText("assets/data/titlescreen/introText.txt");
