...
class GameplayOptions extends OptionsScreen {
    // Carregar som do metrônomo do diretório interno
    var __metronome = FlxG.sound.load("assets/sounds/editors/charter/metronome.ogg");
    ...
    public override function new() {
        ...
        // Adicionar opções de jogabilidade
        add(new Checkbox(
            "Downscroll",
        ...
        add(offsetSetting = new NumOption(
            ...
            999, // máximo
            1, // incremento
            "songOffset", // nome da configuração
    ...
    // Callback para alterar o offset da música
    ...
    public override function close() {
        // Restaurar configurações ao fechar
