...
class KeybindsOptions extends MusicBeatSubstate {
    ...
    public override function create() {
        ...
        bg = new FlxSprite(-80).loadAnimatedGraphic("assets/images/menus/menuTransparent.png");
        coloredBG = new FlxSprite(-80).loadAnimatedGraphic("assets/images/menus/menuDesat.png");
        ...
        if (canSelect) {
            ...
            if (controls.ACCEPT && !skipThisFrame) {
                if (alphabets.members[curSelected] != null) {
                    canSelect = false;
                    CoolUtil.playMenuSFX("assets/sounds/menu/confirm.ogg");
    ...
    public function changeSelection(change:Int) {
        if (change != 0) CoolUtil.playMenuSFX("assets/sounds/menu/scroll.ogg", 0.4);
